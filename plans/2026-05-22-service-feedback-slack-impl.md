...
**Design Spec:** `plans/2026-05-22-service-feedback-slack-design.md`
...
`plans/2026-05-22-service-feedback-slack-impl.md` の Task 11 を参照。
```
...
2. **中期**: Cloudflare Turnstile を導入する別 plan を起こし、設計を更新する。`plans/2026-05-22-service-feedback-slack-design.md` § 8 の「将来の CAPTCHA 追加」を参照
