...
::: tip ベータ版について
Hakari は現在ベータ提供中です。ご利用は無料、Google アカウントによるサインインが必要な招待制となっています。ベータ参加をご希望の方は [お問い合わせ](/contact) からご連絡ください。
:::
...
1. **チーム招待 URL を受け取る** — 個人で始める場合は招待なしでも OK、自分専用チームが自動作成されます
2. **Google アカウントでサインイン** — [hakari.rittoku.llc](https://hakari.rittoku.llc/) を開いて「Google でログイン」
3. **3 銘柄まで選定し、選定理由を入力** — AI が選定理由を問い返してくれます
4. **週初までに確定** — 月曜始値からスコアリングが始まります
5. **毎週土曜朝にチーム内順位を確認** — 日々の通知メールで暫定状況も追えます
6. **6 か月後に総合優勝チームが決定**
...
ベータ期間中は **無料** でご利用いただけます。ベータ参加は招待制ですので、ご希望の方は [お問い合わせ](/contact) からご連絡ください。
